...
local function sendFullStatsToClient(player)
	...
	Comm.Server:FireClient(player, "UpdateStats", fullStats)
...
Comm.Server:On("RequestInitialStats", sendFullStatsToClient)
